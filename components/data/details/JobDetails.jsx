      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
        ...
        <div>
          ...
          <div className="text-xs text-slate-500 italic mb-2">
            ...
            {"  -  "}
            Job Category:{" "}
            <span className="font-semibold">{job.job_category[0].title}</span>
          </div>
                ...
                <div>
                  ...
                  <div>
                    <div className="flex flex-wrap items-center -m-1">
                      {job.job_skill &&
                        job.job_skill.map((skill) => (
                          <div className="m-1" key={skill.uid}>
                            <a
          ...
          <div className="bg-white p-5 shadow-lg rounded-sm border border-slate-200 mb-6 lg:hidden">
            ...
            <div className="space-y-2 sm:flex sm:space-y-0 sm:space-x-2">
              <a
                href={job.job_application_link.href}
              ...
              <Link href={`/company${job.company[0].url}`}>
                <a
                  href={`/company${job.company[0].url}`}
          ...
          <div>
            ...
            <div className="space-y-6 text-slate-500 font-normal text-sm">
              {parse(job.your_responsibilities)}
            </div>
          </div>
          <hr className="my-6 border-t border-slate-200" />
          ...
          {job.related_jobs.length ? (
            <div>
              ...
              <div className="space-y-2 mt-6">
                {job.related_jobs.map((job) => {
                  return <JobCard key={job.uid} job={job} />;
                })}
              </div>
            </div>
          ) : null}
